...
const ROWS: { label: string; value: string }[] = [
  ...
  {
    label: 'お支払い時期',
    value: `ご登録から${PRICING.trialDays}日間は、全機能を無料でお試しいただけます（カード登録は不要です）。プレミアムプランは、お申し込み画面でお支払いのお手続きを完了した時点で決済され、以降は約1か月ごとに自動更新・決済されます。無料お試しのみでご利用を終了される場合、お手続きや料金は不要です。`,
  },
