...
const ROWS: { label: string; value: string }[] = [
  ...
  {
    label: '販売価格',
    value: `月額プラン ${PRICING.monthlyYen}円（税込）\n年額プラン ${PRICING.annualYen}円（税込）`,
  },
  { label: '商品代金以外の必要料金', value: 'インターネット接続に伴う通信費はお客様のご負担となります。' },
  { label: 'お支払い方法', value: 'クレジットカード決済' },
  {
    label: 'お支払い時期',
    value: `ご登録から${PRICING.trialDays}日間は無料でお試しいただけます。お試し期間終了後、選択されたプラン（月額または年額）に応じて自動的に決済が行われます。以降、月額プランは毎月、年額プランは毎年、初回契約日に対応する日に自動更新・決済されます。`,
  },
