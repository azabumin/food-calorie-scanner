...
const ARTICLES: { title: string; body: string }[] = [
  ...
  {
    title: '第4条（料金・お支払い）',
    body: `プレミアムプランは月額${PRICING.monthlyYen}円（税込）または年額${PRICING.annualYen}円（税込）です。新規登録から${PRICING.trialDays}日間は無料でお試しいただけます。お試し期間終了後、選択されたプランに応じて自動的に決済され、以降も自動更新されます。料金・お支払い条件の詳細は特定商取引法に基づく表記をご確認ください。`,
  },
  {
    title: '第5条（解約）',
