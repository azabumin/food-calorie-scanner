...
const ARTICLES: { title: string; body: string }[] = [
  ...
  {
    title: '第4条（料金・お支払い）',
    body: `プレミアムプランは月額${PRICING.monthlyYen}円（税込）です。新規登録から${PRICING.trialDays}日間は、全機能を無料でお試しいただけます（カード登録は不要です）。プレミアムプランは、お申し込み画面でお支払いのお手続きを完了した時点で決済され、以降は約1か月ごとに自動更新されます。12ヶ月連続でご利用いただいた場合、13ヶ月目のご利用料金は無料になります。料金・お支払い条件の詳細は特定商取引法に基づく表記をご確認ください。`,
  },
  {
    title: '第5条（解約）',
