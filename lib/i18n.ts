...
const ko: Strings = {
  ...
  premium: {
    ...
    upgradeTitle: '프리미엄 플랜 안내',
    upgradeBody: '프리미엄에서는 무제한 사진 분석, AI 저녁 코치, 30일·90일 기록을 이용하실 수 있어요.',
    viewPlansButton: '요금제 보기',
  },
...
const ja: Strings = {
  ...
  premium: {
    ...
    upgradeTitle: 'プレミアムプランのご案内',
    upgradeBody: 'プレミアムなら、無制限の写真分析、AI夕食コーチ、30日・90日分の記録をご利用いただけます。',
    viewPlansButton: '料金プランを見る',
  },
...
const en: Strings = {
  ...
  premium: {
    ...
    upgradeTitle: 'About Premium',
    upgradeBody: 'With Premium you get unlimited photo analysis, the AI dinner coach, and 30/90-day history.',
...
const vi: Strings = {
  ...
  premium: {
    ...
    upgradeTitle: 'Giới thiệu gói Premium',
    upgradeBody: 'Với Premium, bạn được phân tích ảnh không giới hạn, huấn luyện viên bữa tối AI và lịch sử 30/90 ngày.',
    viewPlansButton: 'Xem các gói',
  },
...
const zh: Strings = {
  ...
  premium: {
    ...
    upgradeButton: '了解高级版',
    upgradeTitle: '高级版介绍',
    upgradeBody: '升级高级版后,可享受无限次照片分析、AI晚餐教练和30天/90天记录。',
    viewPlansButton: '查看套餐',
  },
  chooseLanguage: '选择语言',
  cancel: '取消',
};
...
const id: Strings = {
  ...
  premium: {
    ...
    upgradeTitle: 'Tentang Premium',
    upgradeBody: 'Dengan Premium, Anda mendapatkan analisis foto tanpa batas, pelatih makan malam AI, dan riwayat 30/90 hari.',
    viewPlansButton: 'Lihat paket',
  },
...
const tl: Strings = {
  ...
  premium: {
    ...
    upgradeTitle: 'Tungkol sa Premium',
    upgradeBody: 'Sa Premium, makukuha mo ang walang limitasyong pagsusuri ng larawan, AI dinner coach, at 30/90 araw na history.',
    viewPlansButton: 'Tingnan ang mga plano',
  },
...
const th: Strings = {
  ...
  premium: {
    ...
    upgradeTitle: 'รู้จักแพ็กเกจ Premium',
    upgradeBody: 'ด้วย Premium คุณจะวิเคราะห์รูปภาพได้ไม่จำกัด ใช้โค้ชมื้อเย็น AI และดูประวัติ 30/90 วัน',
...
const my: Strings = {
  ...
  premium: {
    ...
    upgradeTitle: 'Premium အကြောင်း',
    upgradeBody: 'Premium ဖြင့် ကန့်သတ်မထားသော ဓာတ်ပုံ စိစစ်မှု၊ AI ညစာ နည်းပြနှင့် ၃၀/၉၀ ရက် မှတ်တမ်းကို အသုံးပြုနိုင်ပါသည်။',
    viewPlansButton: 'အစီအစဉ်များ ကြည့်ရန်',
  },
...
const ne: Strings = {
  ...
  premium: {
    ...
    upgradeTitle: 'Premium को बारेमा',
    upgradeBody: 'Premium मा असीमित फोटो विश्लेषण, AI डिनर कोच, र ३०/९० दिनको इतिहास पाइन्छ।',
    viewPlansButton: 'योजनाहरू हेर्नुहोस्',
  },
...
const pt: Strings = {
  ...
  premium: {
    ...
    upgradeTitle: 'Sobre o Premium',
    upgradeBody: 'Com o Premium você tem análise de fotos ilimitada, coach de jantar por IA e histórico de 30/90 dias.',
