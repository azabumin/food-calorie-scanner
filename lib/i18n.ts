...
const ko: Strings = {
  ...
  premium: {
    ...
    comingSoonBody: '무제한 사진 분석, AI 저녁 코치, 30일·90일 기록이 곧 제공됩니다.',
  },
...
const ja: Strings = {
  ...
  premium: {
    ...
    comingSoonBody: '無制限の写真分析、AI夕食コーチ、30日・90日分の記録がまもなく利用可能になります。',
  },
...
const en: Strings = {
  ...
  premium: {
    ...
    comingSoonBody: 'Unlimited photo analysis, the AI dinner coach, and 30/90-day history are coming soon.',
  },
...
const vi: Strings = {
  ...
  premium: {
    ...
    comingSoonBody: 'Phân tích ảnh không giới hạn, huấn luyện viên bữa tối AI, và lịch sử 30/90 ngày sắp có mặt.',
  },
...
const zh: Strings = {
  ...
  premium: {
    ...
    comingSoonBody: '无限次照片分析、AI晚餐教练、30天/90天记录即将推出。',
  },
  chooseLanguage: '选择语言',
  cancel: '取消',
};
...
const id: Strings = {
  ...
  premium: {
    ...
    comingSoonBody: 'Analisis foto tanpa batas, pelatih makan malam AI, dan riwayat 30/90 hari akan segera tersedia.',
  },
...
const tl: Strings = {
  ...
  premium: {
    ...
    comingSoonBody: 'Walang limitasyong pagsusuri ng larawan, AI dinner coach, at 30/90 araw na history ay malapit nang available.',
  },
...
const th: Strings = {
  ...
  premium: {
    ...
    comingSoonBody: 'การวิเคราะห์รูปภาพไม่จำกัด โค้ชมื้อเย็น AI และประวัติ 30/90 วันกำลังจะมาเร็วๆ นี้',
  },
...
const my: Strings = {
  ...
  premium: {
    ...
    comingSoonBody: 'ကန့်သတ်မထားသော ဓာတ်ပုံ စိစစ်မှု၊ AI ညစာ နည်းပြနှင့် ၃၀/၉၀ ရက် မှတ်တမ်းများ မကြာမီ ရရှိနိုင်ပါမည်။',
  },
...
const ne: Strings = {
  ...
  premium: {
    ...
    comingSoonBody: 'असीमित फोटो विश्लेषण, AI डिनर कोच, र ३०/९० दिनको इतिहास चाँडै उपलब्ध हुनेछ।',
  },
...
const pt: Strings = {
  ...
  premium: {
    ...
    comingSoonBody: 'Análise de fotos ilimitada, coach de jantar por IA e histórico de 30/90 dias estarão disponíveis em breve.',
  },
